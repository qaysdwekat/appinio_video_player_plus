...
class _NativeWebVideoPlayerState extends State<NativeWebVideoPlayer> {
  ...
  void initState() {
    super.initState();
    _videoPlayerSettings = widget.customVideoPlayerWebController.webVideoPlayerSettings;
    _initVideoElement();
  }
  ...
  void _initVideoElement() {
    ...
    ui.platformViewRegistry.registerViewFactory(_videoPlayerSettings.src, (int viewId) {
      _video.src = _videoPlayerSettings.src + '#t=${_videoPlayerSettings.startAt}';
      ...
      _video.setAttribute(
        ...
        widget.customVideoPlayerWebController.webVideoPlayerSettings.disablePictureInPicture,
      );
      ...
      _video.onPlay.listen((event) {
        ...
        if (_videoPlayerSettings.enterFullscreenOnStart && _videoPosition == 0) {
      ...
      widget.customVideoPlayerWebController.setPlaybackSpeed = _setPlaybackSpeed;
